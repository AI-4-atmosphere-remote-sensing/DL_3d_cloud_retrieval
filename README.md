...
```
path_model: the path of the saved model you want to run. 

path_1d_retrieval: the path of 1D retrieval results, which were finished by the Physics team at UMBC. 
