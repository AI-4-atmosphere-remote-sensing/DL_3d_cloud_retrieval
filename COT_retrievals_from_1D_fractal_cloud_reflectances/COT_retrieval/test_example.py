...
This code is for testing the trained RNN-based model of single-view COT retrieval at SZA=60 and VZA=0, and visualizing the testing results, by using the example profiles. 
